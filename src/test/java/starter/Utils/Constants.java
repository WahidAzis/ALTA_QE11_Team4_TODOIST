...
public class Constants {
    ...
    public static String REQ_BODY = JSON+"/ReqBody/Project";
    public static String REQ_BODY_SECTIONS = JSON+"/ReqBody/Sections";
    public static String REQ_BODY_TASK = JSON+"/ReqBody/Tasks";
    public static String REQ_BODY_COMMENTS = JSON+"/ReqBody/Comments";
    public static String REQ_BODY_LABELS = JSON+"/ReqBody/Labels";
